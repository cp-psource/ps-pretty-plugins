		...
		<div class="plugin-<?php echo $plugin['ActionLinkClass'];?>">
				...
				<div class="action-links">
					<ul class="plugin-action-buttons">
						...
						<?php if ( isset($plugin['PluginLink']) && $plugin['PluginLink'] ) { ?>
							<li>
								<a href="<?php echo $plugin['PluginLink'];?>" target="_blank" title="<?php _e('Erfahre mehr über das Plugin', 'wmd_prettyplugins') ?>"><?php echo stripslashes($this->options['plugins_link_label']); ?></a>
							</li>
						<?php } ?>
			...
			<?php if ( isset($plugin['CategoriesNames']) && $plugin['CategoriesNames'] ) { ?>
				<div class="plugin-card-bottom">
					<strong><?php _e('Kategorien: ', 'wmd_prettyplugins') ?></strong> <?php echo implode(', ', $plugin['CategoriesNames']);?>
				</div>
			<?php } ?>
		</div>
	</div>

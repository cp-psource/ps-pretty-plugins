					...
					<div class="action-links">
						<ul class="plugin-action-buttons">
							<?php if ( isset($plugin['PluginLink']) && $plugin['PluginLink'] ) { ?>
								<li>
									<a<?php echo apply_filters('prettyplugins_action_link_attrs', ''); ?> href="<?php echo $plugin['PluginLink'];?>" target="_blank" title="<?php _e('Erfahre mehr über dieses Plugin', 'wmd_prettyplugins') ?>"><?php echo stripslashes($this->plugin->options['plugins_link_label']); ?></a>
								</li>
							<?php } ?>
						</ul>				
					</div>
		...
		<div class="plugin-card-top">
			...
			<div class="action-links">
				<ul class="plugin-action-buttons">
					<# if ( data.PluginLink ) { #>
						<li>
							<a<?php echo apply_filters('prettyplugins_action_link_attrs', ''); ?> href="{{ data.PluginLink }}" target="_blank" title="<?php _e('Erfahre mehr über dieses Plugin', 'wmd_prettyplugins') ?>"><?php echo stripslashes($this->plugin->options['plugins_link_label']); ?></a>
						</li>
					<# } #>
				</ul>				
			</div>

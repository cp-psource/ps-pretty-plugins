	...
	<tr style="display:none" id="plugin-edit" class="inline-edit-row inline-edit-row-post inline-edit-post quick-edit-row quick-edit-row-post inline-edit-post alternate inline-editor">
		<td colspan="4" class="colspanchange">
			...
			<div class="inline-edit-col">
				<h4><?php _e('Plugin-Details bearbeiten', 'wmd_prettyplugins'); ?></h4>
				...
				<label>
					<span class="title" id="image_url_tooltip"><?php _e('Bild URL', 'wmd_prettyplugins');?></span>
					<span class="input-text-wrap">
						...
						<a class="plugin_image_upload_button button target" href="#"><?php _e('Bild Wählen', 'wmd_prettyplugins');?></a>
						<a class="plugin_image_edit_button button" href="#" target="_blank"><?php _e('Bild bearbeiten', 'wmd_prettyplugins');?></a>
					</span>
				</label>
			</div>
			</fieldset>
			...
			<div class="inline-edit-col">
				<span class="title inline-edit-categories-label" id="categories_tooltip"><?php _e('Kategorien', 'wmd_prettyplugins');?></span>
						...
						<li class="category-<?php echo $key; ?>">
							<label class="selectit">
								...
								<span class="category-name"><?php echo $value; ?></span>
									<a href="#<?php echo $key; ?>" class="edit-category-show-form"> <small>(<?php _e('bearbeiten', 'wmd_prettyplugins');?>)</small></a>
							</label>
						</li>
					<?php
					}
				...
				<span class="title inline-edit-categories-label">
					<a class="add-category-show-form" href="#"><?php _e('Neue Kategorie', 'wmd_prettyplugins');?></a>
					<span class="edit-category" style="display:none;"><?php _e('Kategorie bearbeiten', 'wmd_prettyplugins');?> <span class="edit-category-name"></span></span>
				</span>
				<div class="plugin-category-add-edit-holder" style="display:none;">
					...
					<a href="#" title="<?php _e('Kategorie hinzufügen', 'wmd_prettyplugins');?>" class="button-secondary category-button add-category-button alignright target"><?php _e('Hinzufügen', 'wmd_prettyplugins');?></a>
					<a href="#" title="<?php _e('Kategorie bearbeiten', 'wmd_prettyplugins');?>" class="button-secondary category-button edit-category-save-button alignright target" style="display:none;"><?php _e('Speichern', 'wmd_prettyplugins');?> </a>
					<a href="#" title="<?php _e('Abbrechen', 'wmd_prettyplugins');?>" class="button-secondary category-cancel-button alignright"><?php _e('Abbrechen', 'wmd_prettyplugins');?></a>
			...
			<div class="inline-edit-col">
				<label class="inline-edit-tags">
					<span class="title" id="description_tooltip"><?php _e('Beschreibung', 'wmd_prettyplugins');?></span>
				...
				<label class="inline-edit-tags setting-disabled">
					<span class="title"><?php _e('Originalbeschreibung', 'wmd_prettyplugins');?></span>
			...
			<p class="submit inline-edit-save">
				...
				<a accesskey="c" href="#" title="Cancel" class="button-secondary plugin-cancel alignleft target"><?php _e('Abbrechen', 'wmd_prettyplugins');?></a>
				<a accesskey="s" href="#" title="Update" class="button-primary plugin-save alignright target"><?php _e('Aktualisieren', 'wmd_prettyplugins');?></a>
